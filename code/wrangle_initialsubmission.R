...
tol <- read.csv('data/thermtol_tests.csv', na.strings = "")
tax <- read.csv('data/thermtol_taxonomy.csv', na.strings = "")
clim <- read.csv('data/thermtol_climate.csv', na.strings = "")
ref <- read.csv('data/thermtol_reference.csv', na.strings = "")
